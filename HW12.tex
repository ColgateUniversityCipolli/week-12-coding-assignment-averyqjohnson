...
\begin{alltt}
  ...
  \hlkwa{for} \hldef{(i} \hlkwa{in} \hlnum{1}\hlopt{:}\hldef{simulations)\{}
    ...
    \hlcom{# conduct left tailed t test}
    \hldef{t_left_1} \hlkwb{<-} \hlkwd{t.test}\hldef{(data_beta1,} \hlkwc{mu}\hldef{=true_means[}\hlnum{1}\hldef{],} \hlkwc{alternative}\hldef{=}\hlsng{"less"}\hldef{)}
    \hldef{t_left_2} \hlkwb{<-} \hlkwd{t.test}\hldef{(data_beta2,} \hlkwc{mu}\hldef{=true_means[}\hlnum{2}\hldef{],} \hlkwc{alternative}\hldef{=}\hlsng{"less"}\hldef{)}
    \hldef{t_left_3} \hlkwb{<-} \hlkwd{t.test}\hldef{(data_beta3,} \hlkwc{mu}\hldef{=true_means[}\hlnum{3}\hldef{],} \hlkwc{alternative}\hldef{=}\hlsng{"less"}\hldef{)}

    \hlcom{# conduct right tailed t test}
    \hldef{t_right_1} \hlkwb{<-} \hlkwd{t.test}\hldef{(data_beta1,} \hlkwc{mu}\hldef{=true_means[}\hlnum{1}\hldef{],} \hlkwc{alternative}\hldef{=}\hlsng{"greater"}\hldef{)}
    \hldef{t_right_2} \hlkwb{<-} \hlkwd{t.test}\hldef{(data_beta2,} \hlkwc{mu}\hldef{=true_means[}\hlnum{2}\hldef{],} \hlkwc{alternative}\hldef{=}\hlsng{"greater"}\hldef{)}
    \hldef{t_right_3} \hlkwb{<-} \hlkwd{t.test}\hldef{(data_beta3,} \hlkwc{mu}\hldef{=true_means[}\hlnum{3}\hldef{],} \hlkwc{alternative}\hldef{=}\hlsng{"greater"}\hldef{)}

    \hlcom{# conduct two tailed t test}
    \hldef{t_two_1} \hlkwb{<-} \hlkwd{t.test}\hldef{(data_beta1,} \hlkwc{mu}\hldef{=true_means[}\hlnum{1}\hldef{],} \hlkwc{alternative}\hldef{=}\hlsng{"two.sided"}\hldef{)}
    \hldef{t_two_2} \hlkwb{<-} \hlkwd{t.test}\hldef{(data_beta2,} \hlkwc{mu}\hldef{=true_means[}\hlnum{2}\hldef{],} \hlkwc{alternative}\hldef{=}\hlsng{"two.sided"}\hldef{)}
    \hldef{t_two_3} \hlkwb{<-} \hlkwd{t.test}\hldef{(data_beta3,} \hlkwc{mu}\hldef{=true_means[}\hlnum{3}\hldef{],} \hlkwc{alternative}\hldef{=}\hlsng{"two.sided"}\hldef{)}

    \hlcom{# count type one errors}
    \hlcom{# Count Type I errors}
    \hldef{type_1_error_left[}\hlnum{1}\hldef{]} \hlkwb{<-} \hldef{type_1_error_left[}\hlnum{1}\hldef{]} \hlopt{+} \hldef{(t_left_1}\hlopt{$}\hldef{p.value} \hlopt{<} \hldef{alpha)}
    \hldef{type_1_error_left[}\hlnum{2}\hldef{]} \hlkwb{<-} \hldef{type_1_error_left[}\hlnum{2}\hldef{]} \hlopt{+} \hldef{(t_left_2}\hlopt{$}\hldef{p.value} \hlopt{<} \hldef{alpha)}
    \hldef{type_1_error_left[}\hlnum{3}\hldef{]} \hlkwb{<-} \hldef{type_1_error_left[}\hlnum{3}\hldef{]} \hlopt{+} \hldef{(t_left_3}\hlopt{$}\hldef{p.value} \hlopt{<} \hldef{alpha)}

    \hldef{type_1_error_right[}\hlnum{1}\hldef{]} \hlkwb{<-} \hldef{type_1_error_right[}\hlnum{1}\hldef{]} \hlopt{+} \hldef{(t_right_1}\hlopt{$}\hldef{p.value} \hlopt{<} \hldef{alpha)}
    \hldef{type_1_error_right[}\hlnum{2}\hldef{]} \hlkwb{<-} \hldef{type_1_error_right[}\hlnum{2}\hldef{]} \hlopt{+} \hldef{(t_right_2}\hlopt{$}\hldef{p.value} \hlopt{<} \hldef{alpha)}
    \hldef{type_1_error_right[}\hlnum{3}\hldef{]} \hlkwb{<-} \hldef{type_1_error_right[}\hlnum{3}\hldef{]} \hlopt{+} \hldef{(t_right_3}\hlopt{$}\hldef{p.value} \hlopt{<} \hldef{alpha)}

    \hldef{type_1_error_two_tailed[}\hlnum{1}\hldef{]} \hlkwb{<-} \hldef{type_1_error_two_tailed[}\hlnum{1}\hldef{]} \hlopt{+} \hldef{(t_two_1}\hlopt{$}\hldef{p.value} \hlopt{<} \hldef{alpha)}
    \hldef{type_1_error_two_tailed[}\hlnum{2}\hldef{]} \hlkwb{<-} \hldef{type_1_error_two_tailed[}\hlnum{2}\hldef{]} \hlopt{+} \hldef{(t_two_2}\hlopt{$}\hldef{p.value} \hlopt{<} \hldef{alpha)}
    \hldef{type_1_error_two_tailed[}\hlnum{3}\hldef{]} \hlkwb{<-} \hldef{type_1_error_two_tailed[}\hlnum{3}\hldef{]} \hlopt{+} \hldef{(t_two_3}\hlopt{$}\hldef{p.value} \hlopt{<} \hldef{alpha)}
  \hldef{\}}


  \hldef{type_1_error_rate_left} \hlkwb{<-} \hldef{type_1_error_left} \hlopt{/} \hldef{simulations}

  \hlcom{# (a) proportion of time we make a Type 1 error for left-tailed}
  \hldef{(type_1_error_rate_left} \hlkwb{<-} \hldef{type_1_error_left} \hlopt{/} \hldef{simulations)}
\end{alltt}
\begin{verbatim}
## [1] 0.0291 0.0820 0.0470
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
  \hlcom{# (b) proportion of time we make a Type 1 error for right-tailed}
\hldef{(type_1_error_rate_right} \hlkwb{<-} \hldef{type_1_error_right} \hlopt{/} \hldef{simulations)}
\end{alltt}
\begin{verbatim}
## [1] 0.0800 0.0299 0.0533
\end{verbatim}
\end{kframe}
\end{knitrout}
